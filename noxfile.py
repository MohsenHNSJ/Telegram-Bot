...
# Package name
package_name: str = "vamo_telbot"
# Python version for environments
python_version: list[str] = ["3.13", "3.14"]
...
@nox.session(name="docs-build", python="3.14", tags=["docs"])
...
@nox.session(name="docs-preview", python="3.14", tags=["preview"])
